...
from heuristics import TYPE_LIBRARY, abstract_problem as rule_abstract_problem
import heuristics
from schema import AbstractInfo
...
def build_label_metadata_from_type_library() -> Dict[str, Dict[str, Any]]:
    ...
    for fine_type, item in heuristics.TYPE_LIBRARY.items():
        metadata[fine_type] = {
